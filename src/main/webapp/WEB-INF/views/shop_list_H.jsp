				...
				<div class="col-lg-9 col-md-7">
					<div class="product__details__tab">
						<ul class="nav nav-tabs" role="tablist">
							<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab" aria-selected="true" title="전체">전체(21)</a></li>
							<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab" aria-selected="false" title="건강">건강(15)</a></li>
							<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab" aria-selected="false" title="미용">미용(6)</a></li>
						</ul>
					</div>
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tabs-1" role="tabpanel">
							<!-- 여기 분류기준 -->
							<div class="row">
								<c:forEach var="shop_list_H" items="${shop_list_H}">
									<a href="shop_detail?b_p_code=${shop_list_H.b_p_code}">
										<div class="col-lg-4 col-md-6 col-sm-6">
											<div class="product__item">
												<div class="product__item__pic set-bg" data-setbg="${contextPath}/resources/bootstrap/img/All/${shop_list_H.b_p_code}.jpg"></div>
												<div class="product__item__text">
													<ul>
														<li style="list-style: none;"><a href="shop_detail?b_p_code=${shop_list_H.b_p_code}" style="color: black;">${shop_list_H.b_product}</a></li>
														<li style="list-style: none; color: Red; float: left; margin-left: 27%;">${shop_list_H.b_discount}%</li>
														<li style="list-style: none; color: gray; margin-right: 32%;"><del>${shop_list_H.b_price}원</del></li>
														<li style="list-style: none; font-weight: bold;">${shop_list_H.b_sale}원</li>
														<c:if test="${shop_list_H.b_spoint==5}">
															<div>
														...
														<c:if test="${shop_list_H.b_spoint==4}">
															<div>
														...
														<c:if test="${shop_list_H.b_spoint==3}">
															<div>
														...
														<c:if test="${shop_list_H.b_spoint==2}">
															<div>
														...
														<c:if test="${shop_list_H.b_spoint==1}">
															<div>
						...
						<div class="tab-pane" id="tabs-2" role="tabpanel">
							<div class="row">
								<c:forEach var="shop_list_H" items="${shop_list_H}">
									<c:if test="${shop_list_H.b_p_category eq '건강'}">
						...
						<div class="tab-pane" id="tabs-3" role="tabpanel">
							<div class="row">
								<c:forEach var="shop_list_H" items="${shop_list_H}">
									<c:if test="${shop_list_H.b_p_category eq '미용'}">
										<a href="shop_detail?b_p_code=${shop_list_H.b_p_code}">
											<div class="col-lg-4 col-md-6 col-sm-6">
												<div class="product__item">
													<div class="product__item__pic set-bg" data-setbg="${contextPath}/resources/bootstrap/img/All/${shop_list_H.b_p_code}.jpg"></div>
