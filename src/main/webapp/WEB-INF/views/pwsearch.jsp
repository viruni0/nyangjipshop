...
$(function(){
   ...
   // 인증번호 확인
	...
	$(".btn-info").click(function(){
		...
		// 값넘기기
		//location.href="pw_s_result?u_name="+u_name+"&u_p_id="+u_p_id+"&u_p_snumber="+u_p_snumber+"&u_phone="+u_phone;
...
<section class="content container-fluid">
	<div class="container">
		...
		<div class="login-form" >
			<form class="box-body" method="get" action="${contextPath}/login/pw_s_result" style="text-align:center;" onsubmit="return validation();">
				<ul style="list-style:none;">
					<li style="text-align:left;">&emsp;이 름</li>
					<input type="text" id="u_name" name="u_name" class="text-field" style="width:337px;" minlength="2">
					<li style="text-align:left;">&emsp;아이디</li>
					<input type="text" id="u_p_id" name="u_p_id" class="text-field" style="width:337px;" minlength="4">
