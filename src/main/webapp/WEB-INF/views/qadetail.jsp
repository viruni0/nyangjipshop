...
$(function(){
   ...
   // Controller와 연결지어서 찾아가기
	//목록 버튼을 눌렀을 때 처리
	$("#us").click(function(){
	   location.href="my_qalist?b_p_bno=" + ${board.b_p_bno};
	});
	$("#ro").click(function(){
	location.href="${contextPath}/mypageGM/qa_gm?b_p_bno=" + ${board.b_p_bno};
	});
	//완료 버튼을 눌렀을 때 처리
	$("#ok").click(function(){
	   location.href="${contextPath}/mypageGM/qa_gmresult?b_p_bno=" + ${board.b_p_bno};
	});
})
           ...
           <div class="box-body">
              <table>
                  <tr>
                     ...
                     <textarea class="form-control" name="b_r_content" id="b_r_content" placeholder="답변을 입력하세요"></textarea>
                     </td>
